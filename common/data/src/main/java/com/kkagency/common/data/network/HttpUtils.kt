package com.kkagency.common.data.network

import com.kkagency.common.data.BuildConfig
import com.kkagency.common.domain.util.DataError
import com.kkagency.common.domain.util.Result
...
suspend inline fun <reified T> safeCall(call: () -> HttpResponse): Result<T, DataError.Network> {
    val response = try {
        call()
